...
textbox = tk.Entry(frame, font=('Comic sans MS', 20))
...
bg_color = 'white'
results = tk.Label(lower_frame, font=('Comic sans MS', 15), anchor='nw', justify='left', bd=4)
results.config(font=('Comic sans MS', 15), bg=bg_color)
